...
class RasterQuery extends GEOOSQuery {
    ...
    query(args) {
        ...
        if (this.format == "isolines") {
            return this.geoServer.client.isolines(this.dataSet.code, this.variable.code, args.time, args.n, args.w, args.s, args.e, args.level);
        } else if (this.format == "isobands") {
            return this.geoServer.client.isobands(this.dataSet.code, this.variable.code, args.time, args.n, args.w, args.s, args.e, args.level);
        }
    }
}