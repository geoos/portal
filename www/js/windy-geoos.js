/*  based on: https://github.com/cambecc */
...
var Windy = function(params) {
    ...
    var FRAME_RATE = params.frameRate || 10;
    ...
    var interpolate = function(λ, φ) {
      ...
      */
      var i = (λ - λ0) / Δλ; // calculate longitude index -180 to +180
      var j = (φ - φ0) / Δφ; // calculate latitude index in direction +90 to -90
